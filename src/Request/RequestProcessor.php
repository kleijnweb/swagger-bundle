...
class RequestProcessor
{
     ...
     */
    public function process(Request $request, Operation $operation)
    {
        $this->coercer->coerceRequest($request, $operation);
        $this->validator->validateRequest($request, $operation);
    }
}
