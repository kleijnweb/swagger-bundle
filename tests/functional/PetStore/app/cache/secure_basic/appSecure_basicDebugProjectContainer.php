...
/**
 * appSecure_basicDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appSecure_basicDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'kernel.listener.petstore_response' => 'getKernel_Listener_PetstoreResponseService',
            'kernel.listener.swagger.exception' => 'getKernel_Listener_Swagger_ExceptionService',
            'kernel.listener.swagger.request' => 'getKernel_Listener_Swagger_RequestService',
            'kernel.listener.swagger.view' => 'getKernel_Listener_Swagger_ViewService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'monolog.handler.null_internal' => 'getMonolog_Handler_NullInternalService',
            'monolog.handler.stderr' => 'getMonolog_Handler_StderrService',
            ...
            'petstore.cache' => 'getPetstore_CacheService',
            ...
            'swagger.controller.entity' => 'getSwagger_Controller_EntityService',
            'swagger.controller.pet' => 'getSwagger_Controller_PetService',
            'swagger.controller.secured' => 'getSwagger_Controller_SecuredService',
            'swagger.controller.store' => 'getSwagger_Controller_StoreService',
            'swagger.controller.user' => 'getSwagger_Controller_UserService',
            'swagger.description.repository' => 'getSwagger_Description_RepositoryService',
            'swagger.request.validator' => 'getSwagger_Request_ValidatorService',
            'swagger.security.request_voter_listener' => 'getSwagger_Security_RequestVoterListenerService',
        ...
        $this->privates = array(
            ...
            'swagger.description.repository' => true,
            'swagger.request.validator' => true,
        );
        $this->aliases = array(
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ImNal66ida', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U1RcwWury6', 0, 'VU0XHWP4eO8eD+99-Wd74+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => $this->get('kernel.class_cache.cache_warmer'), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router'))));
    }
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $this->get('monolog.logger.php', ContainerInterface::NULL_ON_INVALID_REFERENCE), -1, -1, true, new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL), true);
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'kernel.listener.petstore_response', 1 => 'onKernelResponse'), 0);
        $instance->addListenerService('kernel.controller', array(0 => 'data_collector.router', 1 => 'onKernelController'), 0);
        $instance->addListenerService('kernel.view', array(0 => 'kernel.listener.swagger.view', 1 => 'onKernelView'), 0);
        $instance->addListenerService('kernel.exception', array(0 => 'kernel.listener.swagger.exception', 1 => 'onKernelException'), 0);
        $instance->addListenerService('kernel.request', array(0 => 'kernel.listener.swagger.request', 1 => 'onKernelRequest'), 0);
        $instance->addListenerService('kernel.request', array(0 => 'swagger.security.request_voter_listener', 1 => 'onKernelRequest'), 7);
    ...
    /**
     * Gets the 'kernel.listener.petstore_response' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\EventListener\ResponseListener A KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\EventListener\ResponseListener instance
     */
    protected function getKernel_Listener_PetstoreResponseService()
    {
        return $this->services['kernel.listener.petstore_response'] = new \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\EventListener\ResponseListener();
    }

    /**
     * Gets the 'kernel.listener.swagger.exception' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\EventListener\ExceptionListener A KleijnWeb\SwaggerBundle\EventListener\ExceptionListener instance
     */
    protected function getKernel_Listener_Swagger_ExceptionService()
    {
        return $this->services['kernel.listener.swagger.exception'] = new \KleijnWeb\SwaggerBundle\EventListener\ExceptionListener(new \KleijnWeb\SwaggerBundle\EventListener\Response\ErrorResponseFactory\SimpleErrorResponseFactory(), new \KleijnWeb\SwaggerBundle\EventListener\Response\Error\LogRefBuilder\UniqueIdLogRefBuilder(), $this->get('logger'));
    }

    /**
     * Gets the 'kernel.listener.swagger.request' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\EventListener\RequestListener A KleijnWeb\SwaggerBundle\EventListener\RequestListener instance
     */
    protected function getKernel_Listener_Swagger_RequestService()
    {
        return $this->services['kernel.listener.swagger.request'] = new \KleijnWeb\SwaggerBundle\EventListener\RequestListener(new \KleijnWeb\SwaggerBundle\EventListener\Request\RequestProcessor(${($_ = isset($this->services['swagger.description.repository']) ? $this->services['swagger.description.repository'] : $this->getSwagger_Description_RepositoryService()) && false ?: '_'}, ${($_ = isset($this->services['swagger.request.validator']) ? $this->services['swagger.request.validator'] : $this->getSwagger_Request_ValidatorService()) && false ?: '_'}, new \KleijnWeb\PhpApi\Descriptions\Request\RequestParameterAssembler()));
    }

    /**
     * Gets the 'kernel.listener.swagger.view' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\EventListener\ViewListener A KleijnWeb\SwaggerBundle\EventListener\ViewListener instance
     */
    protected function getKernel_Listener_Swagger_ViewService()
    {
        return $this->services['kernel.listener.swagger.view'] = new \KleijnWeb\SwaggerBundle\EventListener\ViewListener(new \KleijnWeb\SwaggerBundle\EventListener\Response\ResponseFactory(NULL, ${($_ = isset($this->services['swagger.request.validator']) ? $this->services['swagger.request.validator'] : $this->getSwagger_Request_ValidatorService()) && false ?: '_'}));
    }
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler($this->get('monolog.handler.stderr'));
    ...
    /**
     * Gets the 'monolog.handler.stderr' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        $this->services['monolog.handler.stderr'] = $instance = new \Monolog\Handler\StreamHandler('php://stdout', 100, true, NULL);
    ...
    /**
     * Gets the 'petstore.cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getPetstore_CacheService()
    {
        return $this->services['petstore.cache'] = new \Doctrine\Common\Cache\ArrayCache();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Symfony\Bundle\SecurityBundle\DataCollector\SecurityDataCollector($this->get('security.token_storage', ContainerInterface::NULL_ON_INVALID_REFERENCE), new \Symfony\Component\Security\Core\Role\RoleHierarchy(array()), ${($_ = isset($this->services['security.logout_url_generator']) ? $this->services['security.logout_url_generator'] : $this->getSecurity_LogoutUrlGeneratorService()) && false ?: '_'}, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, ${($_ = isset($this->services['security.firewall.map']) ? $this->services['security.firewall.map'] : $this->getSecurity_Firewall_MapService()) && false ?: '_'}));
        $instance->add($c);
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $b->addLoader(new \KleijnWeb\SwaggerBundle\Routing\OpenApiRouteLoader(${($_ = isset($this->services['swagger.description.repository']) ? $this->services['swagger.description.repository'] : $this->getSwagger_Description_RepositoryService()) && false ?: '_'}));
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $f = new \Symfony\Component\HttpFoundation\RequestMatcher('/unsecured');

        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/secure');
        ...
        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}), 'default', $a, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), $c), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $d, 'default', new \Symfony\Component\Security\Http\EntryPoint\BasicAuthenticationEntryPoint('Secured Area'), $a), 3 => new \KleijnWeb\SwaggerBundle\Security\RequestAuthorizationListener($this->get('security.authorization_checker')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58e2b9b4f180b8.15908842', $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $h, $d)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $c, new \Symfony\Component\Security\Http\HttpUtils($e, $e), 'default', NULL, NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('default', 'security.user_checker', 'swagger.security.request_matcher', true, false, 'security.user.provider.concrete.in_memory', 'default', NULL, NULL, NULL, array(0 => 'http_basic', 1 => 'swagger', 2 => 'anonymous')));
    }
    ...
    /**
     * Gets the 'swagger.controller.entity' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\EntityController A KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\EntityController instance
     */
    protected function getSwagger_Controller_EntityService()
    {
        return $this->services['swagger.controller.entity'] = new \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\EntityController();
    }

    /**
     * Gets the 'swagger.controller.pet' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\PetController A KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\PetController instance
     */
    protected function getSwagger_Controller_PetService()
    {
        return $this->services['swagger.controller.pet'] = new \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\PetController();
    }

    /**
     * Gets the 'swagger.controller.secured' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\SecuredController A KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\SecuredController instance
     */
    protected function getSwagger_Controller_SecuredService()
    {
        return $this->services['swagger.controller.secured'] = new \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\SecuredController();
    }

    /**
     * Gets the 'swagger.controller.store' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\StoreController A KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\StoreController instance
     */
    protected function getSwagger_Controller_StoreService()
    {
        return $this->services['swagger.controller.store'] = new \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\StoreController();
    }

    /**
     * Gets the 'swagger.controller.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\UserController A KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\UserController instance
     */
    protected function getSwagger_Controller_UserService()
    {
        return $this->services['swagger.controller.user'] = new \KleijnWeb\SwaggerBundle\Tests\Functional\PetStore\Controller\UserController();
    }

    /**
     * Gets the 'swagger.security.request_voter_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \KleijnWeb\SwaggerBundle\Security\AuthorizationCheckerRequestListener A KleijnWeb\SwaggerBundle\Security\AuthorizationCheckerRequestListener instance
     */
    protected function getSwagger_Security_RequestVoterListenerService()
    {
        return $this->services['swagger.security.request_voter_listener'] = new \KleijnWeb\SwaggerBundle\Security\AuthorizationCheckerRequestListener(${($_ = isset($this->services['swagger.description.repository']) ? $this->services['swagger.description.repository'] : $this->getSwagger_Description_RepositoryService()) && false ?: '_'}, $this->get('security.token_storage'), $this->get('security.authorization_checker'), true);
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        ...
        $instance->setVoters(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter(${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : $this->getSecurity_Authentication_TrustResolverService()) && false ?: '_'}), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleVoter()));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'default', $this->get('security.encoder_factory'), true), 1 => new \KleijnWeb\SwaggerBundle\Security\NoopProvider(), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58e2b9b4f180b8.15908842')), true);
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.default' => new \KleijnWeb\SwaggerBundle\Security\RequestMatcher(${($_ = isset($this->services['swagger.description.repository']) ? $this->services['swagger.description.repository'] : $this->getSwagger_Description_RepositoryService()) && false ?: '_'})));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('user', 'password', array(0 => 'ROLE_USER')));
    ...
    /**
     * Gets the 'swagger.description.repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \KleijnWeb\PhpApi\Descriptions\Description\Repository A KleijnWeb\PhpApi\Descriptions\Description\Repository instance
     */
    protected function getSwagger_Description_RepositoryService()
    {
        return $this->services['swagger.description.repository'] = new \KleijnWeb\PhpApi\Descriptions\Description\Repository('tests/functional/PetStore/app', $this->get('petstore.cache'));
    }

    /**
     * Gets the 'swagger.request.validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \KleijnWeb\PhpApi\Descriptions\Description\Schema\Validator\DefaultValidator A KleijnWeb\PhpApi\Descriptions\Description\Schema\Validator\DefaultValidator instance
     */
    protected function getSwagger_Request_ValidatorService()
    {
        return $this->services['swagger.request.validator'] = new \KleijnWeb\PhpApi\Descriptions\Description\Schema\Validator\DefaultValidator();
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => '/home/jkleijn/Projects/php/kleijnweb/swagger-bundle-fresh/vendor/symfony/framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'MonologBundle' => array(
                    'parent' => NULL,
                    'path' => '/home/jkleijn/Projects/php/kleijnweb/swagger-bundle-fresh/vendor/symfony/monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ),
                'KleijnWebSwaggerBundle' => array(
                    'parent' => NULL,
                    'path' => '/home/jkleijn/Projects/php/kleijnweb/swagger-bundle-fresh/src',
                    'namespace' => 'KleijnWeb\\SwaggerBundle',
                ),
                'PetStoreBundle' => array(
                    'parent' => NULL,
                    'path' => $this->targetDirs[3],
                    'namespace' => 'KleijnWeb\\SwaggerBundle\\Tests\\Functional\\PetStore',
                ),
                'SecurityBundle' => array(
                    'parent' => NULL,
                    'path' => '/home/jkleijn/Projects/php/kleijnweb/swagger-bundle-fresh/vendor/symfony/security-bundle',
    ...
    {
        return array(
            'kernel.environment' => 'secure_basic',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            ...
            'kernel.bundles' => array(
                ...
                'KleijnWebSwaggerBundle' => 'KleijnWeb\\SwaggerBundle\\KleijnWebSwaggerBundle',
                'PetStoreBundle' => 'KleijnWeb\\SwaggerBundle\\Tests\\Functional\\PetStore\\PetStoreBundle',
                'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appSecure_basicDebugProjectContainer',
            ...
            'debug.container.dump' => (__DIR__.'/appSecure_basicDebugProjectContainer.xml'),
            ...
            'router.options.matcher.cache_class' => 'appSecure_basicDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'appSecure_basicDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.cache_class_prefix' => 'appSecure_basicDebugProjectContainer',
            ...
            'monolog.handlers_to_channels' => array(
                'monolog.handler.stderr' => NULL,
            ),
            'swagger.document.base_path' => 'tests/functional/PetStore/app',
